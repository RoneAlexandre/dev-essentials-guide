...
import { Menu, X, Phone, MapPin, Clock, Star, ChevronDown, Instagram, MessageCircle } from "lucide-react";
...
const sabores = [
  {
    ...
    desc: "O clássico que você ama, puro e cremoso",
    emoji: "🍇",
    cor: "from-purple-600 to-purple-900",
  },
  {
    nome: "Açaí com Morango",
    desc: "Combinação perfeita de açaí com morangos frescos",
    emoji: "🍓",
    cor: "from-pink-500 to-purple-700",
  },
  {
    nome: "Açaí com Nutella",
    desc: "Para os chocólatras de plantão",
    emoji: "🍫",
    cor: "from-amber-700 to-purple-800",
  },
];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      >
        <div className="container flex items-center justify-between">
          <button onClick={() => scrollTo("hero")} className="font-display text-2xl md:text-3xl text-gradient">
            GARRAFINHA DE AÇAÍ
          </button>

          {/* Desktop nav */}
          <div className="hidden md:flex items-center gap-8">
            {["sabores", "sobre", "depoimentos"].map((s) => (
              <button
                key={s}
                onClick={() => scrollTo(s)}
          ...
          >
            {["sabores", "sobre", "depoimentos"].map((s) => (
              <button
                key={s}
                onClick={() => scrollTo(s)}
                className="font-body text-left text-lg uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors"
              >
                {s}
              </button>
            ))}
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center px-4 pt-20">
          <motion.p
            ...
            className="font-body text-sm md:text-base uppercase tracking-[0.3em] text-secondary mb-4"
          >
          ...
          <motion.h1
            ...
            className="font-display text-6xl md:text-8xl lg:text-9xl leading-none text-gradient mb-6"
          >
            AÇAÍ COMO
            <br />
            VOCÊ NUNCA VIU
          ...
          <motion.p
            ...
            className="font-body text-lg md:text-xl text-muted-foreground max-w-md mx-auto mb-8"
          >
          ...
          >
            <Button
              size="lg"
              className="bg-gradient-brand text-primary-foreground text-lg font-bold px-8 py-6 animate-pulse-glow"
              onClick={() => window.open(WHATSAPP_LINK, "_blank")}
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-primary/30 text-foreground text-lg px-8 py-6 hover:bg-primary/10"
      ...
      {/* SABORES */}
      <section id="sabores" className="py-20 md:py-32">
        <div className="container px-4">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} custom={1} className="font-display text-5xl md:text-7xl text-gradient">
      ...
      <section id="sobre" className="py-20 md:py-32 relative">
        ...
        <div className="container px-4 relative z-10">
          ...
          <motion.div
            ...
            variants={fadeUp}
            custom={3}
            className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-16 glass rounded-2xl p-8 max-w-2xl mx-auto"
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-body text-muted-foreground">Entrega e retirada</span>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 relative">
        ...
        <div className="container px-4 relative z-10 text-center">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <motion.h2 variants={fadeUp} custom={0} className="font-display text-5xl md:text-8xl text-gradient mb-4">
              BORA PEDIR?
            </motion.h2>
            ...
            <motion.div variants={fadeUp} custom={2}>
              <Button
                size="lg"
                className="bg-gradient-brand text-primary-foreground text-xl font-bold px-12 py-7 animate-pulse-glow"
                onClick={() => window.open(WHATSAPP_LINK, "_blank")}
              >
      ...
      <footer className="border-t border-border py-10">
        <div className="container px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <p className="font-display text-2xl text-gradient">GARRAFINHA DE AÇAÍ</p>
